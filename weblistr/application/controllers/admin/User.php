...
class user extends CI_Controller {
    ...
    public function index() {
        ...
        $data['getAllUser'] = $this->user_model->getAllUser();
        
        $this->load->view("admin/user_manage_view", $data); //$this->load->view("registration_view.php", $data);
	...
	public function companyUserStatusUpdate() {
        $this->user_model->companyUserStatusUpdate();
    }
