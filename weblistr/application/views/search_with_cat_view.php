...
<div class="f_bg"><div class="col-md-4 col-sm-4">
...
<div class="f_heading">
<a href="Review/detail/<?php echo $resultValue->prd_id ?>"><h2><?php echo $resultValue->prd_name; ?></h2></a>
<span class="float_rt">	
<?php 
...
//substr($resultValue->prd_info,0,215) ?></div>
...
<?php }  } else {
	?>
	oops! No Result for "<strong><?php  echo $searchfor; ?></strong>" in <strong><?php  echo $cat_name; ?></strong>
	<?php 
	}  ?>
<!--End-->
