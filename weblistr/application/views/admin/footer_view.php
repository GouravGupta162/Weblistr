...
<!-- Review Show Modal Start -->
<div class="modal fade" id="modalreadReview" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
...
<!-- Review Show Modal End -->

<div class="footer">
				<div class="footer-inner">
					<div class="footer-content">
						<span class="bigger-120">
							<span class="blue bolder">The Weblisters</span>
							 &copy; 2016
						</span>
					</div>
				</div>
...
<script src="assets/js/adminnotifications.js"></script>
	</body>
</html>