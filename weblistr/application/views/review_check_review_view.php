...
$this->contact_model->ratingNewWrite($sum,'0');
		...
		?>
			...
			<li><span class="c-count"><?php echo $checker ?>.0</span></li>
...
<?php } ?>
  ...
  <p><?php echo substr($value->prd_info,0,250); ?> </p>
...
$('#share_button').click(function(e){
	...
	e.preventDefault();
...

		{
			...
			description: '<?php echo substr($value->prd_info,0,250) ?>',
...
<span class='pull-right rev-text'><a href="Review/detail/<?php echo $value->prd_id ?>" >view all </a></span></h1>
...
<script>
function reviewactive(rev_id)
{
	var params = {rev_id: rev_id, stts: 1}; //JSON ENCODED 
	var baseHref = document.getElementsByTagName('base')[0].href;
	...
	<?php if($active == 0)
	{		?>
<a href="javascript:void(0);" id="active" onclick="reviewactive('<?php echo $value->rev_id; ?>')" class="pull-left" > Activate </a>
	<?php } 
	?>
	<!--working here-->
	...
	<div class="likes">
			...
			<?php echo $countvalue['like_count']; ?> 
...

{
	...
	?>
        ...
        <div class="rel_body" style='height: 100%; min-height: 125px; max-height: 150px;'>
		...
		?>
          ...
          <div class="r_head top">
            ...
            <h6 class='categoryMain'><a href="Review/detail/<?php echo $search['prd_id'] ?>"><?php echo $search['prd_name']; ?></a></h6>
